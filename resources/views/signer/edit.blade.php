    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="d-flex align-items-center mb-4">
                ...
                <h2 class="fw-bold text-dark mb-0">Edit Signer</h2>
            </div>
            ...
            <div class="card shadow-sm border-0" style="border-radius: 20px;">
                <div class="card-body p-5">
                    <form action="{{ route('signer.update', $signer) }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            <label for="password" class="small fw-bold text-muted text-uppercase mb-2">Password <small class="text-muted">(Leave blank to keep current)</small></label>
                        ...
                        <button type="submit" class="btn btn-primary btn-sm w-100 fw-bold py-2 shadow-sm" style="border-radius: 8px;">
                            <i class="fas fa-save me-2"></i> Update Signer Account
                        </button>
                    </form>
                </div>
            </div>
